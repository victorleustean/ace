            ...
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col items-center justify-center">
                    <div className="section-heading relative text-center mb-4">
                        ...
                        <motion.div
                            className="absolute -left-[350px] 2xl:-left-[450px] -top-[137px] 2xl:-top-[170px] hidden md:block"
                            style={{
                                translateY
                            }}
                        >
                        ...
                        <motion.div
                            className="absolute -right-[331px] 2xl:-right-[420px] -top-[19px] 2xl:-top-[25px] hidden md:block"
                            style={{
                                translateY
                            }}
                        >
