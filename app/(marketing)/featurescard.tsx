                        ...
                        {cardData.map(({ image, title, description }, index) => (
                            <div key={index} className="relative z-0 p-8 md:m-10 w-80 md:w-96 flex-shrink-0 group">
                                ...
                                <div className="flex items-center gap-2 justify-between mt-12">
                                    <Button className="text-sm font-heading uppercase font-extrabold tracking-wider bg-black hover:bg-black active:bg-black text-white border-black hover:border-black active:border-black" variant="primaryOutline">
                                        Afla mai multe
                                    </Button>
